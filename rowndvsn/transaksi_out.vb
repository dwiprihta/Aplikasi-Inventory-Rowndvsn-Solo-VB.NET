...
Public Class transaksi_out
    ...
    Sub nofak()
        Try
            Call bukaDB()
            CMD = New MySqlCommand("select * from tbl_out order by nofak_out DESC",
            Conn)
            ...
            Else
                TextBox1.Text = Val(Microsoft.VisualBasic.Mid(RD.Item("nofak_out").ToString, 4, 3)) + 1
    ...
    Private Sub DataGridView1_CellEndEdit1(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellEndEdit
        ...
        Call hitungtotal()
    End Sub
    Private Sub transaksi_out_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call nofak()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Try
            Call bukaDB()
            CMD = New MySqlCommand("SELECT nofak_out from tbl_out where nofak_out='" & TextBox1.Text & "'", Conn)
            RD = CMD.ExecuteReader
            RD.Read()
            If RD.HasRows Then
            ...
            Else
                ...
                Call bukaDB()
                simpan = "INSERT INTO tbl_out (nofak_out,tgl_out,tottal_item,tottal_bayar) VALUES (@p1,@p2,@p3,@p4)"
                simpan1 = "INSERT INTO tbldetilout (nofak_out,id_barang,ukuran,jumlah) VALUES (@p5,@p6,@p7,@p8) "
